    ...
    return (
        <Fragment>
            <div className="row">
                ...
                <Card>
                        <CardBody>
                        <CardTitle tag="h5">Simple nurture</CardTitle>
                ...
                <Card>
        <CardBody>
          <CardTitle tag="h5">Simple condition-based nurture</CardTitle>
          {/* <CardSubtitle tag="h6" className="mb-2 text-muted">Card subtitle</CardSubtitle> */}
        </CardBody>
        <img width="100%" src={logo} alt="Card image cap" />
        <CardBody>
          ...
          <Row>
                ...
                <Card>
        <CardBody>
          <CardTitle tag="h5">Product trial nurture</CardTitle>
          {/* <CardSubtitle tag="h6" className="mb-2 text-muted">Card subtitle</CardSubtitle> */}
        </CardBody>
        <img width="100%" src={logo} alt="Card image cap" />
        <CardBody>
          ...
          <Row>
                ...
                <Card>
        <CardBody>
          <CardTitle tag="h5">A/B testing for newsletters</CardTitle>
          {/* <CardSubtitle tag="h6" className="mb-2 text-muted">Card subtitle</CardSubtitle> */}
        </CardBody>
        <img width="100%" src={logo} alt="Card image cap" />
        <CardBody>
